...
public class Measurements : MonoBehaviour {
	...
	[HideInInspector] public float widthMeasurement = 0f;
	[HideInInspector] public float heightMeasurement = 0f;
	[HideInInspector] public float depthMeasurement = 0f;
	...
	public void setDistanceObject(GameObject obj) { DistanceObject = obj; }
		...
		// Calculated Values
	public Vector3 getDimensions(){ return new Vector3(widthMeasurement, heightMeasurement, depthMeasurement); }
	...
	void runCalculations()
	{
		...
		widthMeasurement = unitConversion(width_meters);
		heightMeasurement = unitConversion(height_meters);
		depthMeasurement = unitConversion(depth_meters);

		width_string = unitConversionString(widthMeasurement);
		height_string = unitConversionString(heightMeasurement);
		depth_string = unitConversionString(depthMeasurement);
